...
public class TableTest5_TimeAndWindow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> inputStream = env.readTextFile("D:\\idea_workspace\\flinkDemo\\src\\main\\resources\\sensor.txt");
...
//                "id,timestamp.rowtime as ts, temperature as temp");
        ...
        Table dataTable = tableEnv.fromDataStream(dataStream,
                "id,timestamp as ts, temperature as temp,rt.rowtime");
